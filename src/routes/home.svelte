...
<div class="flex flex-col justify-center items-center w-screen h-screen bg-dark-400">
    <div class="text-white py-2">Enter Word</div>
    <div class="flex flex-row justify-center w-screen bg-dark-400">
    ...
    <div class="flex flex-row justify-center w-screen bg-dark-400">
        {#if buttonClicked}
            <div class="flex flex-row bg-dark-400 my-2">
                ...
                <button class="mx-3 border-dark-100 border-1 rounded-lg py-1 px-2 text-white"> Copy to Clipboard</button>
            </div>
        {:else}
            <div></div>
        {/if}
