...
<div class="flex flex-row h-full w-full">
    ...
    <div class="flex flex-col w-full">
        <div class="flex flex-row h-20 bg-dark-400 w-full">
            <div class="w-880">
                <div class="flex w-full justify-center">
                    <div class="h-10 w-145 m-3 bg-dark-900 border-dark-50 border-1 rounded-sm text-true-gray-500 font-bold pl-3 pt-1.4">Search</div>
                </div>
        ...
        <div class="h-full overflow-y-auto bg-dark-800">
            <slot></slot>
        </div>
        <!--
        <div class="h-20 bg-dark-500 border-t-1 border-b-1 border-t-dark-50 border-b-dark-50"></div>
        <div class="h-full overflow-y-auto bg-dark-800"></div>
        -->
    </div>
</div>
